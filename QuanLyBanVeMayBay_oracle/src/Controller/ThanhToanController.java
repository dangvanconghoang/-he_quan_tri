...
//        láº¥y mÃ£ vÃ© ra rá»“i bá»� vÃ´ máº£ng láº·p nhÃ©t vÃ´ next 
    ...
    public void ChuyenDuLieu(String MaVeString, String MaCBString,String DiemDi,String DiemDen,LocalDate NgayDate, int TGBay,String HangMB,int LoaiVe,Timestamp ThoiGianKhoiHanh,int SoNL,int SoTreEm, int GiaVe){
...
//        this.GioBay.setText(GioKH);
        ...
        LoaiVeInt = LoaiVe;
//        GioKhoiHanhString = ThoiGianKhoiHanh;
        GiaVeInt = GiaVe;
